...
{/* Compact refill schedule */}
{stickerSchedule.length > 1 && (
  <div
    style={{
...
>
  <span>
    Instructions for Receiving Patient-Specific Extemporaneous Medication /
    คำแนะนำในการรับยาเตรียมเฉพาะราย
  </span>
  ...
  <div style={{ textAlign: "right" }}>
    ...
    >
      Electronically generated by licensed pharmacist:{" "}
